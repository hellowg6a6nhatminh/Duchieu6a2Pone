...
shared.LoaderTitle = Đức hiếu 6A2 Blox Trái cây";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://97077423004473",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=97077423004473";
v24.Parent = v23;
...
local v166 = v16.Sea:AddParagraph({
    Title = "Hoàn Thành Ải Rồng V4 (Sớm Ra)",
    Content = ""
});
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "Bay Đến Cửa Trial Tộc Rồng",
    Description = "",
    Default = false
});
